  ...
  return (
    <div className="book-grid">
      {displayBooks.map((book) => {
        const formattedPrice = Number(book.price || 0).toLocaleString("ko-KR");
        ...
        return (
          <div className="book-card" key={book.id}>
            ...
            <button className="btn-cart" onClick={() => addCart(book.id)}>
              장바구니 담기
            </button>
          </div>
        );
  ...
  return (
    <div className="box">
      ...
      <div className="login-form">
        ...
        <div className="login-links">아이디 찾기 | 비밀번호 찾기</div>
      </div>
    </div>
  );
}
...
function RankingBox({ books }) {
  ...
  return (
    <div className="box">
      <h3 className="right-title">인기 도서 순위</h3>
